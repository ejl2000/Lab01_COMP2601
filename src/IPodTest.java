...
public class IPodTest {
    ...
    public void testConstructorAndGetters() {
        ...
        assertEquals(1000, iPod.getNumberOfSongs());
        assertEquals(85.0, iPod.getMaxVolume(), 0.001);
    ...
    public void testSetters() {
        ...
        assertEquals(2000, iPod.getNumberOfSongs());
        assertEquals(90.0, iPod.getMaxVolume(), 0.001);
    }
